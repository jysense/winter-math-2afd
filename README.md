...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-math-2afd
```

A live public deployment of this template is available at [https://winter-math-2afd.templates.workers.dev](https://winter-math-2afd.templates.workers.dev)
